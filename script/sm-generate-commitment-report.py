...
def summary(textdoc, commitment_data):
    ...
    p = odf.text.P(stylename=default_bold_style, text=" - The total number of committed story points is " +
                                                      str(commitment_data["total"]["committed"]) + ".")
    textdoc.text.addElement(p)

    sprint_capacity = str(999999999999999999999999999999999999)
    p = odf.text.P(stylename=default_style, text="     - The sprint capacity is " + sprint_capacity + " story points.")
    textdoc.text.addElement(p)
