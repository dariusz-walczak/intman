...
DEFAULT_FILE = "./data/sample/sample_report_data.json"
...
def data_table(cfg, textdoc, sprint_data):
    ...
    tc2 = TableCell()
    tr.addElement(tc2)
    p = P(stylename=desc_cell_style, text="DSADASDSADASDASDSADASDASDASDASDASDASDASDASDASDASDAS")
    tc2.addElement(p)
...
def generate(cfg, commitment_json, sprint_data):
    ...
    summary(textdoc, commitment_json)
    ...
    textdoc.save("./data/odt/sample_sprint_commitment_report_data.odt")
