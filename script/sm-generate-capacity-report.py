...
def create_weekly_table(cfg, doc, week, sprint_data, people):
...
def append_weekly_section(cfg, doc, sprint_data, people):
    ...
    cjm.report.join_elements(
        ...
        *[create_weekly_table(cfg, doc, first_week + week_delta, sprint_data, people)
          for week_delta in range(weeks_cnt)])


def generate_odt_document(cfg, sprint_data, team_data, capacity_data):
    ...
    append_weekly_section(cfg, doc, sprint_data, people)
...
def main(options):
    ...
    generate_odt_document(cfg, sprint_data, team_data, capacity_data)
